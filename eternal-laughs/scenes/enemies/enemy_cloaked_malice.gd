...
@onready var enemy_front_texture: Sprite2D = $Sprite2DEnemyCloakedMaliceFront
@onready var enemy_side_texture: Sprite2D = $Sprite2DEnemyCloakedMaliceSide
@onready var enemy_back_texture: Sprite2D = $Sprite2DEnemyCloakedMaliceBack
